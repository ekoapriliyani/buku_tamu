...
if (isset($_POST["check_in"])) {
    if (detail2($_POST) > 0) {
        echo "<script>
            ...
            document.location.href='tamu_in.php';
        </script>";
    }
}
?>
    ...
    <div class="container">
        ...
        <form action="" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="kode_booking" id="kode_booking" class="form-control fw-bold" value="<?= $tm["kode_booking"]; ?>" readonly>
            </div>
            <div class="mb-3">
            ...
            <input hidden type="text" name="check_in" id="check_in" value="<?= $tm["check_in"]; ?>" readonly>

            <label hidden for="check_out">Check Out</label>
            <input hidden type="text" name="check_out" id="check_out">


            <button class="btn btn-danger mr-5" type="submit" name="check_out" onclick="return confirm('Pastikan Tamu sudah mengembalikan Kartu Visitor');">Check Out</button>
            <a class="btn btn-light" href="tamu_in.php">Kembali</a>
        </form>
